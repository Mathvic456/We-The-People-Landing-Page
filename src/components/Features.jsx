...
export const Features = () => {
    return (
        ...
        <h1 className='text-center font-extrabold text-white mb-8 text-5xl'>Our App Features.</h1>
        <div className='features'>
            ...
            <div className='bottomCard'>
                ...
                <p className='text2'>Get everything about Nigerian politics in your pocket and let your voice be heard.</p>
